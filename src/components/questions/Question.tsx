...
const Question: React.FC<QuestionProps> = ({ question, options, answer, onNext, currentIndex }) => {
    ...
    return (
        <div className='min-h-[90dvh] flex justify-center items-center w-full'>
            {!initQuestions && (
                <div className='w-[40dvw] min-h-[30dvh] p-4 rounded-sm border-2 border-dashed border-border mx-auto gap-5 flex flex-col items-center justify-center'>
            ...
            {initQuestions && (
                <div className='w-[40dvw] min-h-[60dvh] p-4 rounded-sm border border-border mx-auto gap-5 flex flex-col items-center justify-center'>
                    <h1 className='text-start w-[32dvw] text-xl font-bold'>Questão - {currentIndex}</h1>
                    <h2>{question}</h2>
                    <ul className='w-[32dvw] flex flex-col gap-2'>
